...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Strayacoin-seeder\n"
...
static const string mainnet_seeds[] = {"107.191.56.211", "p2pool.mxblue.net.au", "node1.nahyeah.network", "97.74.232.26", "seed.straya.network" ""};
...
extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    //db.Add(CService("kjy2eqzk4zwi5zd3.onion", 9333), true); // This is sipa (bitcoin-seeder dev's) tor node
  }
  do {
